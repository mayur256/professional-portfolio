    ...
    return (
        <header className="p-4">
            <div className="flex flex-col md:flex-row justify-between md:items-center">
                ...
                {/** Navigation links */}
                <div className="hidden space-x-8 pb-4 md:block items-center">
                ...
                <div className="flex justify-between">
                    ...
                    {/** Mobile sidebar */}
                    <div
                        className="lg:hidden bg-[#F1F1F1] dark:bg-gray-800 fixed top-0 left-0 h-full w-64 z-50 transform -translate-x-full transition-transform ease-in-out duration-300"
                        id="sidebar-menu"
                    >
                        {/** Logo or header */}
                        <div className="flex flex-col">
                            ...
                            {navLinks.map(({ link, text }, idx) => {
                                return (
                                    <Link
                                        key={`${text}-${idx}`}
                                        href={link}
                                        className={`capitalize block px-3 py-2
                                            ${router.asPath === link
                                                ? 'font-bold text-white bg-blue-700'
                                                : 'font-medium text-gray-900 dark:text-gray-300 font-normal '
                                            }`
                                        }
                                    >
                                        {text}{' '}
