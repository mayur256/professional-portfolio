...
export const projects = [
	...
	{
		name: 'Weather App',
		description: `The Weather App is an interactive application that that initially displays weather information of users' location with the help of Geolocation API. The System also allows user to query weather information of any other location in the world corresponding to its Zipcode, City, District, Province or State with data supported from Open Weather API.`,
		image: '/weather-app.png',
		url: 'https://weather-app-mayur256.vercel.app/',
	},
	{
		name: 'Chat Application',
		description: `A Simple chat app that facilitates peer to peer transmission of text messages over a web socket. A user can authenticate itself and chat with other users registered on the system directly.`,
		image: '/chat_home.png',
		url: 'https://github.com/mayur256/chat',
	},
	{
		name: 'Shopnet',
